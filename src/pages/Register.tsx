...
export default function Register() {
  ...
  const onSubmit = async (data: RegisterForm) => {
    ...
    try {
      ...
      toast({ title: 'Conta criada!', description: 'Bem-vindo ao MedCare.' });
      navigate('/dashboard');
    } catch (error: any) {
    ...
    >
      ...
      <Card className="w-full max-w-md shadow-xl relative z-10 border-primary/20 bg-card/90 backdrop-blur-sm">
        <CardHeader className="text-center space-y-4">
          ...
          <CardTitle className="text-2xl pt-2">Criar Conta</CardTitle>
          <CardDescription>Comece a gerenciar sua saúde agora</CardDescription>
        </CardHeader>
        <CardContent>
          <Form {...form}>
